...
const DataTable = ({ tableData = [] }) => {
    ...
    const [displayLabelBarChart, setDisplayLabelBarChart] = useState([]);
        ...
        <>
            <div style={{ display: "flex" }}>
                {rows.length > 0 && <div>
                    ...
                    <ColumnsList className=''>
                        <li draggable={false}>Charts</li>
                        <li draggable={false}>Line Charts</li>
                    </ColumnsList>
                </div>}
                <div style={{ width: "100%" }}>
                    ...
                    {rows.length > 0 && <div style={{ display: "flex" }}>
                        <div style={{ width: "600px", margin: "20px", padding: "30px" }}>
                            <LineChart rows={rows} labels={displayLabelBarChart} />
                        </div>
                    </div>}
                </div>
            </div>
